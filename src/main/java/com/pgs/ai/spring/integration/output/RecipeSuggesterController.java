package com.pgs.ai.spring.integration.output;
...
import com.pgs.ai.spring.integration.output.RecipeSuggesterController.Recipe;
...
public class RecipeSuggesterController {
	...
	public Recipe suggestBestRecipeFromIngredient(
	    ...
	    String message = """
	            ...
	            Include the dish name, country of origin and the number of calories in that dish.
	            Just say "I don't know" if you don't know the answer.
	            {format}
	            """;
	    // conversor a Map
	    final BeanOutputConverter<Recipe> beanOutputConverter = new BeanOutputConverter<Recipe>(Recipe.class);
